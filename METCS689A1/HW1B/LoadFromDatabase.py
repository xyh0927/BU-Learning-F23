...
conn = db.connect('Driver={SQL Server};'
                'Server=DESKTOP-H80LIMG\XYH_CHROMEBOOK;'
               'Server=SQLServer-PC;'
...
#conn = pg.connect("dbname=us_national_statistics user=YOUR_POSTGRESQL_USERNAME_HERE password=YOUR_PASSWORD_GOES_HERE")
