...
if __name__ == "__main__":
    ...
    # topWords = allCounts.???
    topWords = allCounts.takeOrdered(numTopWords, key=lambda x: -x[1])
    ...
    # zeroOrOne = allDictionaryWordsInEachDoc.???
    ...
    # idfArray = np.log(np.divide(multiplier, ???))
    ...
    def getPrediction (textInput, k):
        ...
        # numTimes = docIDwithWikiCat.???
        numTimes = docIDwithWikiCat.reduceByKey(add)
