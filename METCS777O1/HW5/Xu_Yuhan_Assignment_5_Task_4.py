...
if __name__ == "__main__":
    ...
    cv = CountVectorizer(inputCol="filtered_words", outputCol="rawFeatures", vocabSize=200)
    ...
    print('The total time needed to train the model: {:.2f} secs\nEvaluate the model: {:.2f} secs\nTest the model: {:.2f} secs\nTotal Time: {:.2f} secs'.format(end_train_time - start_train_time, end_eval_time - start_eval_time, end_test_time - start_test_time,(end_train_time - start_train_time) + (end_eval_time - start_eval_time) + (end_test_time - start_test_time)))
